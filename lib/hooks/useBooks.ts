...
export function useBooks(filters: BooksFilters = {}) {
  return useQuery<BooksResponse>({
    ...
    queryFn: async () => {
      ...
      if (filters.ratingMax !== undefined) params.append('ratingMax', filters.ratingMax.toString());
      if (filters.pageMin !== undefined) params.append('pageMin', filters.pageMin.toString());
      if (filters.pageMax !== undefined) params.append('pageMax', filters.pageMax.toString());
      ...
      if (filters.dateFinishedFrom) params.append('dateFinishedFrom', filters.dateFinishedFrom);
      if (filters.dateFinishedTo) params.append('dateFinishedTo', filters.dateFinishedTo);
